  ...
  return (
    <>
      ...
      <div className="bg-[#00c9a7] text-[#0d3d50] text-center py-1.5 text-xs font-bold">
        🎉 شحن مجاني على الطلبات فوق 5000 جنيه &nbsp;|&nbsp; 📞
        01278389339
      </div>
        ...
        <div className="max-w-[1200px] mx-auto flex items-center justify-between px-4 py-3 gap-3">
          ...
          >
            ...
            <div>
              ...
              <div className="text-[#00c9a7] text-[10px] tracking-widest">
                DENTAL STORE
              </div>
            </div>
          </Link>
            ...
            {isAuth ? (
              <>
                <button
                  ...
                  className="hidden sm:inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-[#00c9a7] text-[#0d3d50] hover:bg-[#00b896] transition-all"
                >
                  تسجيل الخروج
                </button>
            ...
            <div className="pt-2 border-t border-white/10">
              {isAuth ? (
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center justify-center py-2.5 rounded-xl text-sm font-bold text-white border border-white/25 bg-white/10 hover:bg-white/20 transition-all"
                  >
                    تسجيل الخروج
                  </button>
                </div>
